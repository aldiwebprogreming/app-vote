                                          ...
                                          <tbody>
                                            <tr>
                                              <td style='width:130px;'>
                                                <img alt='Profile Picture' height='auto' src='https://64.media.tumblr.com/36d2c7b9f2cd9054ede6fc5f9103ebf9/26c1e36a17b64d59-cb/s1280x1920/4912db6e80ded8f409b769caf1a3205cb401f572.png' style='border:1px solid #ccc;border-radius:5px;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;' width='130' />
                                              </td>
                                            </tr>
                                          </tbody>
                                        </table>
                                    ...
                                    <tr>
                                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                        <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                          ...
                                          <span>
                                            <b>Hello <?= $_GET['id'] ?></b>
                                            <p>Selamat datang di kontes desain cake ebunga, upload produk cake terbaikmu dan dapatkan hadia uang tunai jutaan rupiah.</p>
                                        ...
                                        <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:separate;line-height:100%;'>
                                          <tr>
                                            <td align='center' bgcolor='#ff6f6f' role='presentation' style='background-color:#ff6f6f;border:none;border-radius:5px;cursor:auto;padding:10px 25px;' valign='middle'>
                                              <a href="http://localhost/app-vote/ebunga/verifikasi?kd=<?= $_GET['kd'] ?>" style='background:#ff6f6f;color:#ffffff;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;font-weight:400;line-height:21px;margin:0;text-decoration:none;text-transform:none;' target='_blank'>
                                                VERIFIKASI AKUN
                                              </a>
                                            </td>
                                          </tr>
