                                          ...
                                          <tbody>
                                            <tr>
                                              <td style='width:130px;'>
                                                <img alt='Profile Picture' height='auto' src='https://freepikpsd.com/media/2019/10/piagam-png-5-Transparent-Images.png' style='border:1px solid #ccc;border-radius:5px;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;' width='130' />
                                              </td>
                                            </tr>
                                          </tbody>
                                        </table>
                                    ...
                                    <tr>
                                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                        <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                          ...
                                          <span>
                                            Terima kasih kepada anda yang telah berpartisipasi dalam mengikuti kompetisi lomba desain cake ebunga, dengan ini kami selaku pihak ebunga ingin membrikan penghargaan berupa sertifikat atas berpartisipasinya anda dalam kompetisi ini.
                                          </span>
                                        </div>
                                      </td>
                                    </tr>
